...
if (!class_exists(PasskeySettings::class)) {
    class PasskeySettings extends BaseController
    {
        ...
        public function __construct()
        {
            ...
            add_action('admin_init', [$this, 'registerSMTPSettings']);
        ...
        {
            // phpcs:disable WordPress.Security.NonceVerification.Recommended -- No nonce verification needed as no user data is processed.
            ...
            foreach ($this->options as $option) {
                register_setting($this->settings_group, $option, [
                    'sanitize_callback' => [$this, 'sanitize_smtp_option']
                ]);
            }
            // phpcs:enable
        }
        ...
        /* SMTP Setting */
        public function registerSMTPSettings($hook)
        {
            // phpcs:disable WordPress.Security.NonceVerification.Recommended -- No nonce verification needed as no user data is processed.
            if (!is_admin() || !isset($_GET['page']) || $_GET['page'] !== 'asd-passkey-settings') {
                return;
        ...
        public function sanitize_smtp_option($value)
        {
            if (is_string($value)) {
