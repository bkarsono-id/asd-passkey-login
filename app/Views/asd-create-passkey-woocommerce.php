...
<div class="woocommerce-account">
    <h1 class="woocommerce-MyAccount-title">Create Passkey</h1>
    <form id="createPasskeyForm" method="post" class="woocommerce-form woocommerce-form-edit-account edit-account">
        ...
        <fieldset>
            ...
            <p class="form-row">
                <label for="auth-type-platform" class="woocommerce-form__label">
            ...
            <p class="form-row">
                <label for="auth-type-cross" class="woocommerce-form__label">
                    <input class="woocommerce-form__input woocommerce-form__input-radio"
                        type="radio" name="authenticator_type"
        ...
        <p>
            <button type="submit" class="woocommerce-Button button">Create Passkey</button>
        </p>
    </form>
</div>