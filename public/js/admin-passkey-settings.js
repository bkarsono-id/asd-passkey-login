    ...
    btnSyncPackage.addEventListener("click", async function (event) {
        try {
            ...
            if (result.success) {
                ...
                /* smtp */
                document.getElementById("asd_smtp_host").value = result.data.smtp.smtp_host;
                document.getElementById("asd_smtp_port").value = result.data.smtp.smtp_port;
                document.getElementById("asd_smtp_user").value = result.data.smtp.smtp_user;
                document.getElementById("asd_smtp_password").value = result.data.smtp.smtp_password;
