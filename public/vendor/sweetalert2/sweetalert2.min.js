...
!(function (e, t) {
    ...
    (Ae.text =
        ...
        Ae.week =
        Ae.month =
            (e, t) => (Ce(e, t.inputValue), ve(e, e, t), ye(e, t), (e.type = t.input), e)),
    ...
    const lt = (e) => {
        null === at &&
            ...
            ((at = parseInt(window.getComputedStyle(document.body).getPropertyValue("padding-right"))),
    ...
    function ct(e, t, n, s) {
        q() ? bt(e, s) : (i(n).then(() => bt(e, s)), ze(o)),
            nt ? (t.setAttribute("style", "display:none !important"), t.removeAttribute("class"), (t.innerHTML = "")) : t.remove(),
            D() &&
                (null !== at && ((document.body.style.paddingRight = `${at}px`), (at = null)),
                (() => {
    ...
    const mt = (e) => {
        ...
        ht = (e) => (void 0 === e ? { isConfirmed: !1, isDenied: !1, isDismissed: !0 } : Object.assign({ isConfirmed: !1, isDenied: !1, isDismissed: !1 }, e)),
        gt = (e, t, n) => {
            var i;
            const s = y(),
                r = ne(t);
            "function" == typeof n.willClose && n.willClose(t),
                ...
                r ? ft(e, t, s, n.returnFocus, n.didClose) : ct(e, s, n.returnFocus, n.didClose);
        },
        ft = (e, t, n, i, s) => {
    ...
    const Ut = {
        ...
        en = (e) => {
            !1 === e.backdrop && e.allowOutsideClick && u('"allowOutsideClick" parameter requires `backdrop` parameter to be set to `true`'),
                e.theme && !["light", "dark", "auto", "borderless"].includes(e.theme) && u(`Invalid theme "${e.theme}". Expected "light", "dark", "auto", or "borderless"`);
    ...
    const Un = (e, t, n) =>
                ...
                et.swalPromiseResolve.set(e, i),
                    ...
                    ((e, t) => {
                        "select" === t.input || "radio" === t.input
                            ? Et(e, t)
                            : ["text", "email", "number", "tel", "textarea"].some((e) => e === t.input) && (g(t.inputValue) || b(t.inputValue)) && (yt(x()), kt(e, t));
                    })(e, n),
                    Mn(n),
                    Kn(o, n, r),
                    Yn(t, n),
        ...
        Wn = (e) => {
            const t = { popup: C(), container: y(), actions: O(), confirmButton: x(), denyButton: T(), cancelButton: P(), loader: S(), closeButton: H(), validationMessage: $(), progressSteps: L() };
